<template>
  <div>
    ...
    <component
      ...
      v-bind="field"
    ></component>
    <p>Hello {{formData.title}} {{formData.firstName}} {{formData.lastName}}, I hear you are {{formData.age}} {{agePlurality(formData.age)}} old.</p>
  </div>
</template>
      ...
      schema: [
        {
          ...
          multi: false,
          label: "Title",
          options: ["", "Mr", "Ms", "Honorable", "Dr", "Madam", "Lord"]
        },
        {
          fieldType: "TextInput",
